...
session_start();
    ...
    function generate_html_for_lesson_plan($con, $event_id, $admin){
        ...
        $lesson_plan_html .= "<option value=\"0\">not-approved</option>\n";
        $lesson_plan_html .= "<option value=\"1\">approved</option>\n";
        $lesson_plan_html .= "<option value=\"2\">approval requested</option>\n";
    ...
    function html_for_equipment($con, $event_id, $parade_id, $G4){
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while($equipment_request = mysqli_fetch_assoc($result)){
                ...
                $all_html .= "<option value=\"1\">approved</option>\n";
