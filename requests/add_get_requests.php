...
if(isset($_GET["search_parade_name"])){    include_once("get_request_scanning.php");
...
if(isset($_GET["search_first_name_user"])){    include_once("get_request_scanning.php");
...
if(isset($_GET["search_last_name_user"])){    include_once("get_request_scanning.php");
...
if(isset($_GET["search_equipment_name"])){    include_once("get_request_scanning.php");
...
if(isset($_GET["search_equipment_location"])){    include_once("get_request_scanning.php");
...
if(isset($_GET["equipment_id_info_dump"])){    include_once("get_request_scanning.php");
...
if(isset($_GET["user_id_info_dump"])){    include_once("get_request_scanning.php");
